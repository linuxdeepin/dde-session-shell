 ...
 * Command line was: qdbusxml2cpp ./dde-session-shell/xml/com.deepin.wm.xml -a ./dde-session-shell/toolGenerate/qdbusxml2cpp/com.deepin.wmAdaptor -i ./dde-session-shell/toolGenerate/qdbusxml2cpp/com.deepin.wm.h
 *
...
#include "./dde-session-shell/toolGenerate/qdbusxml2cpp/com.deepin.wmAdaptor.h"
...
bool WmAdaptor::GetCurrentDesktopStatus()
{
    // handle method call com.deepin.wm.GetCurrentDesktopStatus
    bool isDesktop;
    QMetaObject::invokeMethod(parent(), "GetCurrentDesktopStatus", Q_RETURN_ARG(bool, isDesktop));
    return isDesktop;
}
...
double WmAdaptor::GetTouchBorderInterval()
{
    // handle method call com.deepin.wm.GetTouchBorderInterval
    double interval;
    QMetaObject::invokeMethod(parent(), "GetTouchBorderInterval", Q_RETURN_ARG(double, interval));
    return interval;
}
...
void WmAdaptor::SetTouchBorderInterval(double interval)
{
    // handle method call com.deepin.wm.SetTouchBorderInterval
    QMetaObject::invokeMethod(parent(), "SetTouchBorderInterval", Q_ARG(double, interval));
}
